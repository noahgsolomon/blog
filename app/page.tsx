  ...
  return (
    <div className='flex flex-col gap-24 text-center px-4 mx-auto max-w-[600px] w-full py-64 items-center min-h-[90vh]'>
      ...
      <div className='w-full flex flex-col'>
        <Link href={'/lexer-in-zig'} className='p-3 flex flex-col gap-2 rounded-lg relative hover:bg-[#1a1b26]'>
          <div className='flex flex-col gap-2 z-10'>
            <div className='flex w-full justify-between items-center'>
              <p className='underline underline-offset-4 text-[#5692ae] hover:text-[#5692ae] visited:text-[#8466aa]'>
        ...
        <Link href={'/ppo'} className='p-3 flex flex-col gap-2 rounded-lg relative hover:bg-[#1a1b26]'>
