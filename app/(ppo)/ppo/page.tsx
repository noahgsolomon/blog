  ...
  return (
    <Layout>
      <div className='w-screen h-[90vh] fine:h-screen overflow-hidden flex flex-col lg:flex-row'>
        ...
        <a className={buttonVariants({ variant: 'outline', className: 'absolute top-4 left-4 z-20' })} href={'/'}>
          <ChevronLeft className='size-4' />
        </a>
        <h1 className='text-xl lg:text-2xl absolute z-20 top-12 left-1/2 lg:left-1/3 -translate-x-1/2 font-bold'>
